...
def roll_once(strategy, score, score_opponent, dice, num_rolls, margin):
    """
    returns SCORE0 and SCORE1 after a player has played in a turn
    """
    # print("roll_once")
    num_dice = strategy(score, score_opponent, num_rolls, margin)
...
#delete num_roll, margin parameters!!!
def play(strategy0, strategy1, num_rolls, margin, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while True:
        ...
        # print("player", who)
        if who == 0:
            score0, score1 = roll_once(strategy0, score0, score1, dice_choice, num_rolls, margin)
        else:
            score1, score0 = roll_once(strategy1, score1, score0, dice_choice, num_rolls, margin)
        # if who == 0:
        #     num_dice = strategy0(score0, score1)
        #     turn_score = take_turn(num_dice, score1, dice_choice)
        #     score0 += turn_score
        #     if turn_score == 0:
        #         score1 += num_dice
        # elif who == 1:
        #     num_dice = strategy1(score1, score0)
        #     turn_score = take_turn(num_dice, score0, dice_choice)
        #     score1 += turn_score
        #     if turn_score == 0:
        #         score0 += num_dice
...
def run_experiments():
    ...
    if 0:  # Change to False when done finding max_scoring_num_rolls
        six_sided_max, final_max = max_scoring_num_rolls(six_sided)
        print('Max scoring num rolls for six-sided dice:', six_sided_max, final_max)
        four_sided_max, final_max2 = max_scoring_num_rolls(four_sided)
        print('Max scoring num rolls for four-sided dice:', four_sided_max, final_max2)
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    """
    # BEGIN Question 8
    # opponent_digit_one, opponent_digit_two = get_digit(opponent_score, 1, 2)
    # zero_roll = max(opponent_digit_one, opponent_digit_two) + 1
...
def final_strategy(score, opponent_score, num_rolls, margin, goal=GOAL_SCORE):
...
def test_final():
    for num_dice in range(0, 10):
        for dice_margin in range(0, 10):
            average_win_rate(final_strategy)
